...
export default function ProviderNavbar({ wallet, notifications = [], unreadCount = 0, markAllRead = () => {} }) {
    ...
    >
      <div className="cd-nav__inner" ref={wrapRef}>
        ...
        <div className="cd-nav__actions">
          ...
          {/* Wallet pill */}
          <Link
            to="/dashboard/provider/wallet"
            className="cd-wallet-pill"
            aria-label="Available credits — view wallet"
            title="Credits earned from completed workloads."
            ...
            {openMenu === 'profile' && (
              <div className="cd-menu" role="dialog" aria-label="Profile menu">
                ...
                <button
                  ...
                  onClick={() => {
                    setOpenMenu(null);
                    navigate('/dashboard/provider/wallet');
                  }}
                >
                  <IconWallet /> Wallet
                </button>
